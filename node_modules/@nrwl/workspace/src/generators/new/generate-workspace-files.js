...
function createFiles(tree, options) {
    ...
    (0, devkit_1.generateFiles)(tree, (0, path_1.join)(__dirname, filesDirName), options.directory, Object.assign(Object.assign({ formattedNames, dot: '.', tmpl: '', cliCommand: options.preset === presets_1.Preset.AngularMonorepo ? 'ng' : 'nx', nxCli: false, typescriptVersion: versions_1.typescriptVersion,
...
function createPrettierrc(tree, options) {
    (0, devkit_1.writeJson)(tree, (0, path_1.join)(options.directory, '.prettierrc'), exports.DEFAULT_NRWL_PRETTIER_CONFIG);
}
