...
function lintWorkspaceRulesProjectGenerator(tree) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield (0, devkit_1.ensurePackage)(tree, '@nrwl/jest/', versions_2.nxVersion);
        const { addPropertyToJestConfig, jestProjectGenerator } = yield Promise.resolve().then(() => require('@nrwl/jest'));
        ...
        (0, devkit_1.generateFiles)(tree, (0, path_1.join)(__dirname, 'files'), workspace_lint_rules_1.workspaceLintPluginDir, {
            ...
            rootTsConfigPath: (0, typescript_1.getRelativePathToRootTsConfig)(tree, exports.WORKSPACE_PLUGIN_DIR),
        });
        /**
        ...
        if ((_b = (_a = workspaceConfig.targetDefaults) === null || _a === void 0 ? void 0 : _a.lint) === null || _b === void 0 ? void 0 : _b.inputs) {
            workspaceConfig.targetDefaults.lint.inputs.push(`{workspaceRoot}/${exports.WORKSPACE_PLUGIN_DIR}/**/*`);
