...
function cypressComponentConfigGenerator(tree, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        yield (0, devkit_1.ensurePackage)(tree, '@nrwl/cypress', versions_1.nxVersion);
        const { cypressComponentProject } = yield Promise.resolve().then(() => require('@nrwl/cypress'));
        ...
        yield (0, add_files_1.addFiles)(tree, projectConfig, options);
