...
function normalizeOptions(host, options) {
    ...
    const { libsDir: defaultLibsDir, npmScope } = (0, devkit_1.getWorkspaceLayout)(host);
    ...
    normalized.unitTestRunner =
        (_c = normalized.unitTestRunner) !== null && _c !== void 0 ? _c : (normalized.bundler === 'vite' ? 'vitest' : 'jest');
