...
function libraryGenerator(host, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.buildable && options.bundler === 'vite') {
            yield (0, devkit_1.ensurePackage)(host, '@nrwl/vite', versions_1.nxVersion);
            const { viteConfigurationGenerator } = yield Promise.resolve().then(() => require('@nrwl/vite'));
        ...
        if (options.unitTestRunner === 'jest') {
            yield (0, devkit_1.ensurePackage)(host, '@nrwl/jest', versions_1.nxVersion);
            const { jestProjectGenerator } = yield Promise.resolve().then(() => require('@nrwl/jest'));
            const jestTask = yield jestProjectGenerator(host, Object.assign(Object.assign({}, options), { project: options.name, setupFile: 'none', supportTsx: true, skipSerializers: true, compiler: options.compiler }));
            tasks.push(jestTask);
            ...
            yield (0, devkit_1.ensurePackage)(host, '@nrwl/vite', versions_1.nxVersion);
            const { vitestGenerator } = yield Promise.resolve().then(() => require('@nrwl/vite'));
