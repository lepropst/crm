...
function getWebpackConfigs(options, context) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return yield Promise.all([
            ...
            (0, get_webpack_config_1.getWebpackConfig)(context, options, true, isScriptOptimizeOn),
            // ES5 build for legacy browsers.
            options.target === 'web' &&
                isScriptOptimizeOn &&
                buildBrowserFeatures.isDifferentialLoadingNeeded()
                ? (0, get_webpack_config_1.getWebpackConfig)(context, options, false, isScriptOptimizeOn)
                : undefined,
        ]
            .filter(Boolean)
...
function webpackExecutor(_options, context) {
    ...
    return tslib_1.__asyncGenerator(this, arguments, function* webpackExecutor_1() {
        ...
        const options = (0, normalize_options_1.normalizeOptions)(_options, context.root, sourceRoot);
        const isScriptOptimizeOn = typeof options.optimization === 'boolean'
            ? options.optimization
            : options.optimization && options.optimization.scripts
                ? options.optimization.scripts
        ...
        (0, operators_1.bufferCount)(configs.length), (0, operators_1.switchMap)(([result1, result2]) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const emittedFiles1 = (0, get_emitted_files_1.getEmittedFiles)(result1);
            const emittedFiles2 = result2 ? (0, get_emitted_files_1.getEmittedFiles)(result2) : [];
