...
function ssrDevServerExecutor(options, context) {
    ...
    return tslib_1.__asyncGenerator(this, arguments, function* ssrDevServerExecutor_1() {
        var e_1, _b;
        const browserTarget = (0, devkit_1.parseTargetString)(options.browserTarget);
        const serverTarget = (0, devkit_1.parseTargetString)(options.serverTarget);
        ...
        const combined = (0, async_iterable_1.combineAsyncIterableIterators)(runBrowser, runServer);
        process.env['port'] = `${options.port}`;
        try {
            for (var combined_1 = tslib_1.__asyncValues(combined), combined_1_1; combined_1_1 = yield tslib_1.__await(combined_1.next()), !combined_1_1.done;) {
            ...
            try {
                if (combined_1_1 && !combined_1_1.done && (_b = combined_1.return)) yield tslib_1.__await(_b.call(combined_1));
            }
